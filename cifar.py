...
def read_file_with_delay(file_path, delay_seconds=4.2):
    try:
        with open(file_path, 'r') as file:
            for line in file:
...
def load_dataset(dataset_name, kernel_types):
    ...
    if dataset_name == 'cifar10' and kernel_types == 'laplician':
    ...
    if dataset_name == 'cifar100' and kernel_types == 'non':
        print('Processing CIFAR-10 with "non" kernel type')
    ...
    if dataset_name == 'cifar100' and kernel_types == 'laplician':
